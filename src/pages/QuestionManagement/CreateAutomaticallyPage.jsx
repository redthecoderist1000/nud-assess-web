...
import InputField from "../../components/elements/InputField"; // Ensure this import is included
import PasteOrUpload from "../../components/elements/PasteOrUpload"; // Ensure this import is included
...
const CreateAutomaticallyPage = () => {
  ...
  const handleDeploy = () => {
    ...
    console.log(
      "✅ Form is valid! Navigating to QuestionResultPage...",
      finalFormData
    );
