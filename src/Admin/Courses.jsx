...
const Program = () => {
  ...
  return (
    <div>
      <AdminNav />
      <div className="p-5">
        <h1 className="text-2xl font-bold mb-5">Program Managemendt</h1>
        <div className="mb-5">
        ...
        {selectedProgram &&
          selectedYearLevel &&
          subjects[selectedProgram]?.[selectedYearLevel] && (
            <>
              <button
              ...
              <table className="w-full border-collapse border border-gray-300">
                ...
                <tbody>
                  {subjects[selectedProgram][selectedYearLevel].map(
                    (subject, index) => (
