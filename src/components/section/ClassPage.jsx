...
const ClassPage = () => {
  ...
  const [people, setPeople] = useState([
    ...
    { id: 6, name: "Fiona Gallagher", avatar: "https://via.placeholder.com/150" },
    ...
    { id: 10, name: "Jessica Davis", avatar: "https://via.placeholder.com/150" },
    { id: 11, name: "Kevin Hart", avatar: "https://via.placeholder.com/150" },
    { id: 12, name: "Laura Palmer", avatar: "https://via.placeholder.com/150" },
    { id: 13, name: "Michael Scott", avatar: "https://via.placeholder.com/150" },
  ...
  const quizzes = [
    { id: 1, title: "Math Quiz 1", due: "10:00 am", turnedIn: 10, total: 30, items: 20 },
    { id: 2, title: "Science Quiz 1", due: "12:00 pm", turnedIn: 15, total: 40, items: 25 },
    { id: 3, title: "History Quiz 1", due: "2:00 pm", turnedIn: 20, total: 50, items: 30 },
    { id: 4, title: "English Quiz 1", due: "3:30 pm", turnedIn: 25, total: 60, items: 35 },
    { id: 5, title: "Geography Quiz 1", due: "4:00 pm", turnedIn: 18, total: 45, items: 40 },
    { id: 6, title: "Math Quiz 2", due: "9:00 am", turnedIn: 12, total: 35, items: 15 },
    { id: 7, title: "Science Quiz 2", due: "11:00 am", turnedIn: 22, total: 50, items: 20 },
    { id: 8, title: "History Quiz 2", due: "1:00 pm", turnedIn: 30, total: 60, items: 25 },
    { id: 9, title: "English Quiz 2", due: "3:00 pm", turnedIn: 28, total: 55, items: 30 },
    { id: 10, title: "Geography Quiz 2", due: "5:00 pm", turnedIn: 35, total: 70, items: 40 },
    { id: 11, title: "Math Quiz 3", due: "8:30 am", turnedIn: 8, total: 25, items: 10 },
    { id: 12, title: "Science Quiz 3", due: "10:30 am", turnedIn: 16, total: 40, items: 15 },
    { id: 13, title: "History Quiz 3", due: "12:30 pm", turnedIn: 24, total: 50, items: 20 },
    { id: 14, title: "English Quiz 3", due: "2:30 pm", turnedIn: 32, total: 60, items: 25 },
  ];
  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden">
      ...
      >
        <h1 className="text-7xl font-bold mt-30 text-white">{classData.title}</h1>
        <img src={Header} alt="Header" className="h-60 object-contain ml-4 mt-5" />
      </div>
            ...
            {people.map((person) => (
              ...
              >
                ...
                <button
                  ...
                  onClick={(e) => {
                    e.stopPropagation();
                    setDropdownVisible(dropdownVisible === person.id ? null : person.id);
                  }}
                >
                  ⋮
                </button>
