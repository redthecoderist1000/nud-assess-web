...
const Privacy = ({
  ...
  <div className="w-full bg-white rounded-lg border border-gray-200 p-6">
    ...
    <div className="mb-4">
      ...
      <p className="text-gray-500 text-sm">Update your password and manage account access</p>
    </div>
    <form>
    ...
    <div className="mb-4">
      ...
      >
        <svg width="18" height="18" fill="none" viewBox="0 0 24 24">
          <path d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a2 2 0 01-2 2H7a2 2 0 01-2-2V7a2 2 0 012-2h4a2 2 0 012 2v1" stroke="#555" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
        Log Out Account
      </button>
    </div>
    ...
    <div>
      <h3 className="text-md font-semibold text-red-600 mb-1">Delete Account</h3>
      <p className="text-gray-500 text-sm mb-2">
      ...
      >
        <svg width="18" height="18" fill="none" viewBox="0 0 24 24">
          <path d="M6 7h12M9 7V5a3 3 0 016 0v2m-9 0v10a2 2 0 002 2h6a2 2 0 002-2V7" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
        Delete Account
      </button>
    </div>
